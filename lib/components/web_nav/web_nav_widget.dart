            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: FFAppState().activeNavIndex == 0
                          ? widget!.colorBgOne
                          : Color(0x00000000),
                      borderRadius: BorderRadius.circular(8.0),
                    ),
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: FFAppState().activeNavIndex == 1
                          ? widget!.colorBgTwo
                          : Color(0x00000000),
                      borderRadius: BorderRadius.circular(8.0),
                    ),
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: FFAppState().activeNavIndex == 2
                          ? widget!.colorBgThree
                          : Color(0x00000000),
                      borderRadius: BorderRadius.circular(8.0),
                    ),
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: FFAppState().activeNavIndex == 3
                          ? widget!.colorBgFour
                          : Color(0x00000000),
                      borderRadius: BorderRadius.circular(8.0),
                    ),
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  highlightColor: Colors.transparent,
                  onTap: () async {
                    FFAppState().activeNavIndex = 4;
                    safeSetState(() {});

                    context.pushNamed(
                      CheckoutManagementWidget.routeName,
                      extra: <String, dynamic>{
                        kTransitionInfoKey: TransitionInfo(
                          hasTransition: true,
                          transitionType: PageTransitionType.fade,
                  ...
                  child: Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: FFAppState().activeNavIndex == 4
                          ? widget!.colorBgFive
                          : Color(0x00000000),
                      borderRadius: BorderRadius.circular(8.0),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            color: FFAppState().activeNavIndex == 5
                                ? FlutterFlowTheme.of(context).primary
                                : FlutterFlowTheme.of(context).secondaryText,
                            size: 28.0,
                          ),
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 190.0, 0.0, 20.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
