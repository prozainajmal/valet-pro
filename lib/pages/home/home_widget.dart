...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.startOfMonth = getCurrentTimestamp;
      _model.endOfMonth = _model.endOfMonth;
      safeSetState(() {});
      await queryTransactionsRecordOnce(
        queryBuilder: (transactionsRecord) => transactionsRecord
            ...
            .where(
              'company_id',
              isEqualTo: _model.currentCompanyRef,
            ),
      );
      // Number of Agent Count
      _model.activeAgentsQuery = await queryValetAgentsRecordOnce(
        queryBuilder: (valetAgentsRecord) => valetAgentsRecord.where(
          'is_active',
          isEqualTo: true,
        ),
      );
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'pdl4u0y8' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '6uzfie80' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'fmo4vuat' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'cpqptb0u' /* Below is an a summary of activ... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
