...
class _CreateAccountWidgetState extends State<CreateAccountWidget>
  ...
  void initState() {
    ...
    _model.companyTypeTextController ??= TextEditingController();
    _model.companyTypeFocusNode ??= FocusNode();

    _model.workPhoneNumberTextController ??= TextEditingController();
    _model.workPhoneNumberFocusNode ??= FocusNode();
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (Theme.of(context).brightness ==
                                  Brightness.dark)
                                Image.asset(
                                  'assets/images/Headline_Large_(Logo)_(500_x_125_px)_(3).png',
                                  width: 170.0,
                                  height: 60.0,
                                  fit: BoxFit.fitWidth,
                                ),
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '0uknk55c' /* Enter your company name */,
                                      ),
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 16.0, 0.0, 0.0),
                                child: TextFormField(
                                  controller: _model.companyTypeTextController,
                                  focusNode: _model.companyTypeFocusNode,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'oh9uhyzh' /* Company Type */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'u1wd86pp' /* Enter your company type */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                  ...
                                  validator: _model
                                      .companyTypeTextControllerValidator
                                      .asValidator(context),
                                ).animateOnPageLoad(animationsMap[
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  controller:
                                      _model.workPhoneNumberTextController,
                                  focusNode: _model.workPhoneNumberFocusNode,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'p9cyvpkf' /* Work Phone Number */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '2df4k41h' /* Enter your work phone number */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                  ...
                                  validator: _model
                                      .workPhoneNumberTextControllerValidator
                                      .asValidator(context),
                                ).animateOnPageLoad(animationsMap[
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'w09ermz5' /* Enter your email here... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
